...
*/
export function greet(number_string) {
    const ptr0 = passStringToWasm0(number_string, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
...
function getImports() {
    const imports = {};
    imports.wbg = {};
    imports.wbg.__wbg_alert_ab61742d96c5f42d = function(arg0, arg1) {
        try {
...
async function init(input) {
    if (typeof input === 'undefined') {
        input = new URL('simulation-trunk-29173098c9ab41f9_bg.wasm', import.meta.url);
    }
    const imports = getImports();
